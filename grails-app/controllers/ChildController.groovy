        ...
        if (childInstance) {
            if (params.version) {
                ...
                if (childInstance.version > version) {
                    ...
                    childInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [message(code: 'child.label', default: 'Child')] as Object[], "Another user has updated this Child while you were editing")
